...
plant1 = MiFloraPoller("C4:7C:8D:61:95:E9", GatttoolBackend, cache_timeout=900)
plant2 = MiFloraPoller("C4:7C:8D:61:92:49", GatttoolBackend, cache_timeout=900)
plant3 = MiFloraPoller("C4:7C:8D:61:99:B3", GatttoolBackend, cache_timeout=900)
plant4 = MiFloraPoller("C4:7C:8D:62:A3:55", GatttoolBackend, cache_timeout=900)
plant5 = MiFloraPoller("C4:7C:8D:62:A2:D0", GatttoolBackend, cache_timeout=900)
plant6 = MiFloraPoller("C4:7C:8D:62:99:7E", GatttoolBackend, cache_timeout=900)
plant7 = MiFloraPoller("C4:7C:8D:62:A0:C5", GatttoolBackend, cache_timeout=900)
plant8 = MiFloraPoller("C4:7C:8D:62:9A:B4", GatttoolBackend, cache_timeout=900)
